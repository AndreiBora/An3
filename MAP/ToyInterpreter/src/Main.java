...
//           closeRFile (var_f)
        ...
        //a =  10 + (2 < 6)
        IStmt st10 = new AssignStmt("a", new ArithExp('+', new ConstExp(10), new BooleanExp(
                new ConstExp(2),
                new ConstExp(6),
                "<"
        )));
        ...
        IFileTable fileTable10 = new FileTable();
        IHeap<Integer> heap10 = new Heap<>();

        exeStack10.push(st10);
        PrgState prgState10 = new PrgState(exeStack10, symTable10, out10, fileTable10, heap10);
        IRepository repo10 = new Repository(prgState10, "log.txt");
        ...
        IFileTable fileTable11 = new FileTable();
        IHeap<Integer> heap11 = new Heap<>();

        exeStack11.push(st11);
        PrgState prgState11 = new PrgState(exeStack11, symTable11, out11, fileTable11, heap11);
        IRepository repo11 = new Repository(prgState11, "log.txt");
...
//
        ...
        IFileTable fileTable12 = new FileTable();
        IHeap<Integer> heap12 = new Heap<>();

        exeStack12.push(st12);
        PrgState prgState12 = new PrgState(exeStack12, symTable12, out12, fileTable12, heap12);
